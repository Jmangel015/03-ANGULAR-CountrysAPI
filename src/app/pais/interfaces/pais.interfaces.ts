...
//
//   const searchPaisResponse = Convert.toSearchPaisResponse(json);
//
...
export class Convert {
  public static toSearchPaisResponse(json: string): Country[] {
    return cast(JSON.parse(json), a(r('SearchPaisResponse')));
  }

  public static searchPaisResponseToJson(value: Country[]): string {
    return JSON.stringify(uncast(value, a(r('SearchPaisResponse'))), null, 2);
  }
}
